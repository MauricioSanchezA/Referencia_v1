<?php
    ...
    if (isset($busqueda) && $busqueda != "") {
        ...
        $consulta_total = "SELECT COUNT(categoria_id) 
                           FROM categoria 
                           WHERE categoria_nombre LIKE :busqueda 
                              OR categoria_ubicacion LIKE :busqueda";
    } else {
        ...
        foreach ($datos as $rows) {
            $tabla .= '
                <tr class="has-text-centered">
                    ...
                    <td>
                        <a href="index.php?vista=product_category&category_id=' . $rows['categoria_id'] . '" class="button is-link is-rounded is-small">Ver EPS</a>
                    </td>
                    <td>
