...
<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle">Actualizar Pacientes ACEPTADOS</h2>
</div>
...
<div class="container pb-6 pt-6">
	<?php
		...
		$id = (isset($_GET['pacientacept_id_up'])) ? $_GET['pacientacept_id_up'] : 0;
		$id=limpiar_cadena($id);

		/*== Verificando categoria ==*/
    	$check_paciente=conexion();
    	$check_paciente=$check_paciente->query("SELECT * FROM paciente_aceptado WHERE paciente_id='$id'");
    ...
    <div class="columns">
        ...
        <div class="column">
            ...
            <div class="control">
                <div class="select">
                    <select name="paciente_estado" id="estado_select" required>
    ...
    <div class="columns" id="">
        <div class="column">
            <div class="control">
                <label>Código</label>
                <input class="input" type="text" name="codigo" id="codigo_paciente" required value="<?php echo $datos['codigo']; ?>" >
            </div>
        </div>
    </div>
    ...
    <div class="columns">
        <div class="column">
            <div class="control">
                ...
                <input class="input" type="text" name="num_cama" required value="<?php echo $datos['num_cama']; ?>" >
            </div>
        </div>
        <div class="column">
            <div class="control">
                <label>Remitido Por</label>
                <input class="input" type="text" name="remitido_por" required="<?php echo $datos['remitido_por']; ?>" >
            </div>
        </div>
    </div>
    <div class="columns">
        <div class="column">
            <div class="control">
                ...
                <input class="input" type="date" name="fecha_entrada" required value="<?php echo $datos['fecha_entrada']; ?>" >
            </div>
        </div>
        <div class="column">
            <div class="control">
                <label>Fecha de Salida</label>
                <input class="input" type="date" name="fecha_salida" required value="<?php echo $datos['fecha_salida']; ?>" >
            </div>
        </div>
    </div>
</div>
        ...
        fetch(action, config)
            ...
            .then(respuesta => {
                ...
                setTimeout(() => {
                    ...
                    let url = "index.php?vista=pacientacept_update&page=" + pagina;
...
function generarCodigo() {
    ...
    const constante = "D"; // Constante que se añade al código
    ...
    .then(data => {
        ...
        const codigo = dias[diaSemana] + meses[mes] + ("0" + diaDelMes).slice(-2) + constante + consecutivo;
